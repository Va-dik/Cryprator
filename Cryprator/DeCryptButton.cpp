...
System::Void Cryprator::CrypratorForm::toolStripDeCryptButton_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	try
	{
		...
		Security::Cryptography::ICryptoTransform^ enc = crpt->CreateDecryptor(key, IV);
		String^ fileName = pathDic[treeView1->SelectedNode] + listView1->SelectedItems[0]->Text;
		IO::FileStream^ fs = gcnew FileStream(fileName, FileMode::Open, FileAccess::ReadWrite);
